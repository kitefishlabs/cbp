{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 430.0, 564.0, 342.0, 241.0 ],
		"bglocked" : 0,
		"defrect" : [ 430.0, 564.0, 342.0, 241.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 200.0, 96.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 220.0, 165.0, 20.0 ],
					"text" : "cbp.send2 /descriptors #1 #2"
				}
