{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 2176.0, 268.0, 793.0, 464.0 ],
		"bglocked" : 0,
		"defrect" : [ 2176.0, 268.0, 793.0, 464.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 160.0, 425.0, 32.5, 19.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 155.0, 94.0, 19.0 ],
					"text" : "switch 3 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 130.0, 215.0, 20.0 ],
					"text" : "cbp.receive2 /display #4 #3_to_lcd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 105.0, 215.0, 20.0 ],
					"text" : "cbp.receive2 /display #4 #2_to_lcd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 30.0, 365.0, 200.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 40.0, 200.0, 20.0 ],
					"tabs" : [ "A", "B", "C" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 80.0, 215.0, 20.0 ],
					"text" : "cbp.receive2 /display #4 #1_to_lcd"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 350.0, 180.0, 280.0, 280.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 60.0, 280.0, 280.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 160.0, 131.0, 19.0 ],
...
,
					"patching_rect" : [ 375.0, 45.0, 122.0, 24.0 ],
...
,
					"patching_rect" : [ 375.0, 15.0, 271.0, 24.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"globalpatchername" : "",
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 43.0, 234.0, 56.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 200.0, 302.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 160.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 235.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 270.0, 155.0, 17.0 ],
					"text" : "/tab 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 30.0, 390.0, 284.0, 31.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 52.5, 265.5, 330.5, 265.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 52.5, 265.5, 69.5, 265.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 39.5, 424.0, 22.0, 424.0, 22.0, 361.0, 39.5, 361.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 169.5, 453.0, 343.5, 453.0, 343.5, 145.0, 359.5, 145.0 ],
					"source" : [ "obj-9", 0 ]
				}
